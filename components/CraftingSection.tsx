...
const CraftingSection = () => {
  return (
    <div className="w-full bg-stone-50 py-20 md:py-32 overflow-hidden border-t border-stone-200">
        <div className="px-6 md:px-12 mb-8 md:mb-16 text-center">
             <span className="text-[10px] uppercase tracking-[0.3em] text-stone-400 mb-4 block animate-fade-in">Behind the Seams</span>
             <h2 className="font-serif text-4xl md:text-6xl text-obsidian mb-6 animate-fade-in-up">Crafted with Intention</h2>
             <p className="max-w-xl mx-auto text-sm text-stone-500 leading-relaxed animate-fade-in-up" style={{ animationDelay: '100ms' }}>
