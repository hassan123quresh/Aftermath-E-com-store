  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-4 md:px-6 max-w-4xl mx-auto animate-fade-in font-sans text-obsidian">
        ...
        <div className="mb-16 text-center">
            <h1 className="text-4xl md:text-5xl font-serif italic mb-4">Shipping Policy</h1>
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Policy Overview</h2>
            ...
            {/* Contact */}
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Initiating a Return</h2>
                <p className="text-sm leading-relaxed opacity-80">
                    To start a return, you can contact us at: <a href="mailto:hello@aftermathstore.com" className="underline hover:text-stone-500">hello@aftermathstore.com</a>
                    <br/><br/>
            ...
            <div className="bg-obsidian text-stone-100 p-6 md:p-10 shadow-sm">
                ...
                <p className="text-sm leading-relaxed opacity-80">
                    ...
                    <br/><br/>
                    If more than 15 business days have passed since we’ve approved your return, please contact us at: <a href="mailto:hello@aftermathstore.com" className="underline hover:text-stone-300">hello@aftermathstore.com</a>
                </p>
            </div>
        </div>
    </div>
