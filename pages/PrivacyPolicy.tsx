        ...
        <div className="space-y-8">
            ...
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <p className="text-sm leading-relaxed opacity-80">
                    Aftermath operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Aftermath is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
                    <br/><br/>
            ...
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Personal Information We Collect or Process</h2>
            ...
            {/* Sources */}
             <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Personal Information Sources</h2>
                <div className="text-sm leading-relaxed opacity-80 space-y-4">
            ...
            {/* How We Use */}
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">How We Use Your Personal Information</h2>
                <div className="text-sm leading-relaxed opacity-80 space-y-4">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                         ...
                         <li><strong>Marketing and Advertising.</strong> We use your personal information to marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you online advertisements for products or services on the Services or other websites, including based on items you previously have purchased or added to your cart and other activity on the Services.</li>
            ...
            {/* How We Disclose */}
             <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">How We Disclose Personal Information</h2>
                <div className="text-sm leading-relaxed opacity-80 space-y-4">
            ...
            {/* Children's Data */}
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Children's Data</h2>
                <p className="text-sm leading-relaxed opacity-80">
            ...
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Security and Retention of Your Information</h2>
                <div className="text-sm leading-relaxed opacity-80 space-y-4">
            ...
            {/* Your Rights and Choices */}
             <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Your Rights and Choices</h2>
                <div className="text-sm leading-relaxed opacity-80 space-y-4">
                    ...
                    <p>You may exercise any of these rights where indicated on the Services or by contacting us using the contact details provided below. To learn more about how Shopify uses your personal information and any rights you may have, including rights related to data processed by Shopify, you can visit <a href="https://privacy.shopify.com/en" target="_blank" rel="noreferrer" className="underline">https://privacy.shopify.com/en</a>.</p>
            ...
            {/* Complaints */}
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Complaints</h2>
                <p className="text-sm leading-relaxed opacity-80">
            ...
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">International Transfers</h2>
                <p className="text-sm leading-relaxed opacity-80">
            ...
            {/* Changes */}
            <div className="bg-white border border-stone-200 p-6 md:p-10 shadow-sm">
                <h2 className="font-serif text-2xl mb-6">Changes to This Privacy Policy</h2>
                <p className="text-sm leading-relaxed opacity-80">
            ...
            <div className="bg-obsidian text-stone-100 p-6 md:p-10 shadow-sm">
                ...
                <p className="text-sm leading-relaxed opacity-80">
                    ...
                    <br/><br/>
                    <strong>Email:</strong> <a href="mailto:saadwasim1@hotmail.com" className="underline hover:text-stone-300">saadwasim1@hotmail.com</a>
                    <br/>
                    <strong>Address:</strong> Block C Faisal Town, Lahore, 54770, PK
                </p>
            </div>
